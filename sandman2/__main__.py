...
def main():
    ...
    parser.add_argument(
        '-v',
        '--view',
        help='Use the views view1_name/view1_pk_name/view1_pktype,view2_name/view2_pk_name/view2_pktype. pktype is in string,int,float',
        default=None)

    args = parser.parse_args()
    app = get_app(args.URI, read_only=args.read_only, schema=args.schema, str_viewpktype=args.view)
    if args.enable_cors:
